...
export default function RoadmapVerticalSecond({ aS, iA, tH }) {
  ...
  const content = [
    ...
    },
    {
      title: "Round 1-4",
      content:
        "Round 1. Build a community~nHere we begin building a strong community of committed supporters that will bring Boxing Boyz to life. ~n~nRound 2. Pre sale~nWe’ll open presale during this phase, and those who earn a whitelist spot can get in early on the action.~n~nRound 3. NFT Launch~n5,000 uniquely generated boxing characters 🥊 will drop, giving all of you guys access to our exciting new NFT. ~n~nRound 4. Reveal huge partnership~nAt the end of this phase we’ll announce a HUGE PARTNERSHIP that will be a real game changer. ",
    },
    {
      title: "Round 5-8",
      content:
        "Round 5. IDO~nOnce this phase begins we’ll launch or IDO, really kicking things off.~n~nRound 6. Token launch~nFinally, you’ll be able to get your hands on $BOXING!~n~nRound 7. DEX~nHere you’ll be able to start exchanging your $BOXING with other users.~n~nRound 8. Staking~nStaking of $BOXING will be released here.",
    },
    {
      title: "Round 9-11",
      content:
        "Round 9. Marketplace~nOur marketplace launches here, so look forward to plenty of purchasable items to make your NFT even more powerful or unique. ~n~nRound 10. Battle arena~nUse the items purchased in our marketplace to show your opponents who the strongest Boxing Boyz fighter is!~n~nRound 11. Tournaments~nFinally, tournaments with huge prizes will begin here. That’s what we’re all saying for!",
    },
    {
